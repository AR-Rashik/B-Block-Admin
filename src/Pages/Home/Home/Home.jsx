...
const Home = () => {
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="w-64 absolute sm:relative bg-slate-100 shadow md:h-full flex-col justify-between flex">
        <div className="px-8">
          ...
          <ul className="mt-12 mb-80">
            <li className="flex w-full justify-between text-gray-600 hover:text-emerald-500 font-semibold transition-colors duration-300 transform cursor-pointer items-center mb-6">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-grid text-emerald-500"
                  width={18}
                  height={18}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-emerald-500 transition-colors duration-300 transform font-semibold cursor-pointer items-center mb-6">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-puzzle text-emerald-500"
                  width={18}
                  height={18}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
                ...
                <span className="text-sm  ml-2">Client</span>
              </div>
              {/* <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
                8
              </div> */}
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-emerald-500 transition-colors duration-300 transform font-semibold cursor-pointer items-center mb-6">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-compass text-emerald-500"
                  width={18}
                  height={18}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-emerald-500 transition-colors duration-300 transform font-semibold cursor-pointer items-center">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-settings text-emerald-500"
                  width={18}
                  height={18}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
          ...
          <div className="flex justify-center mt-48 mb-4 w-full">
            <div className="relative ">
              ...
              <input
                className="focus:outline-none rounded w-full text-sm text-gray-600 bg-gray-200 pl-10 py-2"
                type="text"
                placeholder="Search"
              />
            </div>
        ...
        <div className="px-8 border-t border-emerald-500">
