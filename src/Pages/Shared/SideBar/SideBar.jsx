      ...
      <div className="w-64 md:sticky top-20 left-0 sm:relative bg-slate-100 shadow md:h-full flex-col justify-between hidden sm:flex">
        <div className="px-8">
          <ul className="mt-12 mb-80">
            ...
            <Link
              to="/addclient"
              className="flex w-full justify-between text-gray-600 hover:text-emerald-500 transition-colors duration-300 transform font-semibold cursor-pointer items-center mb-6"
            >
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-sm  ml-2">Add Client</span>
              </div>
              {/* <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
                8
              </div> */}
